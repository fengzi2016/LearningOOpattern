...
/**
 * 找出player赋给this.player
 * 初始化this.status=this.finishDelay=null
 * 调用isFinished 返回 布尔值，true则结束， false则没有结束
 */
...
/**
 * 每个Vector实例传入的两个参数为，x,y坐标
 * plus(other)增加坐标量，返回移动后的坐标
 * times(factor)坐标乘以一个因变量，返回相乘后的坐标
 */
var actorChars = {
  "@": Player,
  "o": Coin,
